...
<TabItem label="TypeScript">
```ts
const value = interaction.getRequiredInputValue("field_custom_id");
```
</TabItem>
<TabItem label="JavaScript">
```js
...
client.on("interactionCreate", async (interaction) => {
  ...
  if (interaction.customId === "feedback_modal") {
    const subject = interaction.getRequiredInputValue("subject");
    const body = interaction.getRequiredInputValue("body");
