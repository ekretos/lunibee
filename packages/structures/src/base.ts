...
/** Context used by structures to delegate resource operations to the owning client. */
export interface ResourceContext {
    ...
    sendMessage(channelId: string, options: { content?: string }): Promise<import("./index.js").Message>;
    ...
    editMessage(channelId: string, messageId: string, options: { content?: string }): Promise<import("./index.js").Message>;
...
export class User extends BaseStructure {
    ...
    /** Gets the effective display name. @returns Global display name or username. */
    public get displayName(): string { return this.globalName ?? this.username; }
    /** Creates an avatar CDN URL. @param options URL format options. @returns Avatar URL, or null when no custom avatar exists. */
    ...
    /** Creates the default avatar URL. @returns Discord default avatar URL. */
    public defaultAvatarURL(): string { return `https://cdn.discordapp.com/embed/avatars/${Number(BigInt(this.id) % 5n)}.png`; }
    /** Creates an avatar URL with default fallback. @param options URL format options. @returns Avatar or default avatar URL. */
...
export class Channel extends BaseStructure {
    ...
    public sendMessage(options: { content?: string }): Promise<import("./index.js").Message> {
