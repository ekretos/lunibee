...
export class Embed {
  ...
  public setDescription(description: string): this {
    if (description.length > 4096)
      throw new TypeError("Embed description must not exceed 4096 characters.");
  ...
  public setFooter(text: string, iconURL?: string): this {
    if (text.length > 2048)
      throw new TypeError("Embed footer text must not exceed 2048 characters.");
  ...
  public setAuthor(
    ...
    if (name.length > 256)
      throw new TypeError("Embed author name must not exceed 256 characters.");
    this.#data.author = {
      name,
      url: options.url,
