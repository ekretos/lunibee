...
export class User extends BaseStructure {
    ...
    /** Discord mention string. */ public toString(): string { return `<@${this.id}>`; }
}
...
export class Guild extends BaseStructure {
    ...
    /** Discord guild mention is not supported; returns the resource ID. */ public toString(): string { return this.id; }
}
...
export class Message extends BaseStructure {
    ...
    /** Message author mention. */ public get authorMention(): string { return this.author.toString(); }
}
