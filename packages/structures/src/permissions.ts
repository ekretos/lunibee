...
export const Permissions = {
    ...
    /** Manage guild expressions permission. */ ManageGuildExpressions:
        1n << 30n,
    /** Use application commands permission. */ UseApplicationCommands:
        1n << 31n,
    ...
    /** Send messages in threads permission. */ SendMessagesInThreads:
        1n << 38n,
    ...
    /** Create guild expressions permission. */ CreateGuildExpressions:
        1n << 43n,
