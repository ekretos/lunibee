...
export class ButtonBuilder {
    ...
    public setURL(value: string): this { validateText(value, 512, "Button URL"); let url: URL; try { url = new URL(value); } catch (error) { throw new TypeError("Button URL must be a valid URL.", { cause: error }); } this.#data.style = ButtonStyle.Link; delete this.#data.custom_id; this.#data.url = url.toString(); return this; }
