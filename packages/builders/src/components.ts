...
export class ActionRowBuilder<T extends { toJSON(): APIActionRowChild } = { toJSON(): APIActionRowChild }> {
    /** Components currently in the row. */
    readonly #components: T[] = [];
    /** Adds components. @param components Components to add. @returns This builder. @throws {TypeError} When no components are supplied. @throws {RangeError} When more than five components would be present. */
    ...
    /** Clears all components. @returns This builder. */
    public clearComponents(): this { this.#components.length = 0; return this; }
    /** Serializes the action row. @returns Strict action-row payload. */
...
export class StringSelectBuilder {
    ...
    /** Sets the placeholder. @param value Placeholder. @returns This builder. */
    ...
    /** Sets the minimum value count. @param value Count. @returns This builder. */
    public setMinValues(value: number): this { validateCount(value, "min_values", 0); this.#data.min_values = value; return this; }
    /** Sets the maximum value count. @param value Count. @returns This builder. */
    public setMaxValues(value: number): this { validateCount(value, "max_values", 1); this.#data.max_values = value; return this; }
    /** Sets required state. @param value Required state. @returns This builder. */
    public setRequired(value = true): this { this.#data.required = value; return this; }
    /** Adds select options. @param options Options to add. @returns This builder. @throws {RangeError} When more than 25 options would be present. */
...
export class ButtonBuilder {
    ...
    /** Sets custom identifier. @param value Identifier. @returns This builder. */
    ...
    /** Sets button label. @param value Label. @returns This builder. */
    public setLabel(value: string): this { validateText(value, 80, "Button label"); this.#data.label = value; return this; }
    /** Sets button URL and link style. @param value URL. @returns This builder. @throws {TypeError} For invalid URLs. */
    ...
    /** Sets button emoji. @param value Emoji. @returns This builder. */
    public setEmoji(value: APIComponentEmoji): this { this.#data.emoji = { ...value }; return this; }
    /** Sets disabled state. @param value Disabled state. @returns This builder. */
...
export class EntitySelectBuilder {
    ...
    /** Sets custom identifier. @param value Identifier. @returns This builder. */
    public setCustomId(value: string): this { validateText(value, 100, "Component custom ID"); this.#data.custom_id = value; return this; }
    /** Sets placeholder. @param value Placeholder. @returns This builder. */
    public setPlaceholder(value: string): this { validateText(value, 150, "Component placeholder"); this.#data.placeholder = value; return this; }
    /** Sets minimum selections. @param value Count. @returns This builder. */
    public setMinValues(value: number): this { validateCount(value, "min_values", 0); this.#data.min_values = value; return this; }
    /** Sets maximum selections. @param value Count. @returns This builder. */
    public setMaxValues(value: number): this { validateCount(value, "max_values", 1); this.#data.max_values = value; return this; }
    /** Sets required state. @param value Required state. @returns This builder. */
    public setRequired(value = true): this { this.#data.required = value; return this; }
    /** Sets disabled state. @param value Disabled state. @returns This builder. */
...
export class ModalBuilder {
    /** Mutable modal payload. */
    readonly #data: APIModalComponent = { type: 9, components: [] };
    /** Sets modal custom identifier. @param value Identifier. @returns This builder. */
    public setCustomId(value: string): this { validateText(value, 100, "Modal custom ID"); this.#data.custom_id = value; return this; }
    /** Sets modal title. @param value Title. @returns This builder. */
    public setTitle(value: string): this { validateText(value, 45, "Modal title"); this.#data.title = value; return this; }
    /** Adds modal components. @param components Components. @returns This builder. @throws {RangeError} When more than five components are supplied. */
...
/** Validates bounded Discord text. @param value Value. @param max Maximum length. @param name Field name. @returns Validated text. */
...
/** Validates a component count. @param value Count. @param field Field name. @param minimum Minimum. @returns Nothing. */
...
/** Validates a text length. @param value Length. @param field Field name. @param maximum Maximum. @returns Nothing. */
...
/** Validates an absolute URL. @param value URL. @param field Field name. @returns Normalized URL. */
