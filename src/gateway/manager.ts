...
export class GatewayManager {
    ...
    public constructor(options: ClientOptions, dispatch: (payload: GatewayPayload) => void) {
    ...
    public async connect(): Promise<void> {
        ...
        this.#open(`${info.url}?v=10&encoding=json`);
    }
    ...
    #scheduleReconnect(): void {
        ...
        const base = config?.reconnectBaseDelay ?? 1000;
        const maxDelay = config?.reconnectMaxDelay ?? 30000;
